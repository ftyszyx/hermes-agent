...
def inline_shell_argv(command: str) -> list[str]:
...
def run_inline_shell(command: str, cwd: Path | None, timeout: int) -> str:
    ...
    if platform.system() == "Windows" and cwd and command.strip() == "pwd" and completed.returncode == 0:
        output = str(cwd)
